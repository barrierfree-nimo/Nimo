...
import { SafeAreaView, View, Text, TouchableOpacity, Modal, StyleSheet, Dimensions, Linking } from 'react-native'
    ...
    <SafeAreaView style={CommonStyle.container}>
      ...
      <View style={styles.container_contents}>
        <View style={styles.container_info}>
          ...
          <View style={styles.container_info_item}>
            ...
            <Text style={styles.text_info_value}>{Math.floor(route.params.donePercent)} %</Text>
          </View>
        </View>
        ...
        <View style={styles.container_setting}>
          ...
          {/* 로그아웃 */}
          <TouchableOpacity style={styles.btn_setting} onPress={() => setModalVisible(!modalVisible)}>
            ...
            onRequestClose={() => {
              ...
              <View style={styles.container_modal}>
                <View style={styles.container_modal_main}>
                  <Text style={styles.text_modal_question}>로그아웃 하시겠습니까?</Text>
                  <View style={styles.container_modal_main_options}>
                    <TouchableOpacity onPress={() => {setModalVisible(!modalVisible), logout()}}>
          ...
          {/* 공지사항 */}
          <TouchableOpacity style={styles.btn_setting} onPress={() => Linking.openURL(notice)}>
            <Text style={styles.title_setting}>공지사항</Text>
          </TouchableOpacity>

          {/* 문의하기 */}
          <TouchableOpacity style={styles.btn_setting}  onPress={() => Linking.openURL(contact)}>
      ...
      <View style={CommonStyle.container_exit}>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Text style={CommonStyle.btnText_exit}>설정 나가기</Text>
        </TouchableOpacity>
      </View>
